    ...
    def plotData(self, data, display_name):
        try:
            ...
            if self.bounding_boxes and bounding_box_key in self.bounding_boxes:
                ...
                translation_vector = self.bounding_box_offset_x * self.x_dir + self.bounding_box_offset_y * self.y_dir
                ...
                transformed_points = pv.PolyData(refined_mesh.points) + translation_vector
